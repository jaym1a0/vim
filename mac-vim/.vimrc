...
map <leader>cct :silent !ctags -R -f ~/.vim/commtags --c++-kinds=+p --fields=+iaS --exclude=*.js --extra=+q ;<cr>:set tags+=~/.vim/commtags<CR>
"set tags+=~/.vim/commtags
" 创建taglist,当前目录下生成tags文件
" map <leader>ctl :silent !ctags -R --c++-kinds=+p --fields=+iaS --extra=+q ./ <cr>
